...
class TestCircleArea(unittest.TestCase):
    ...
    def test_positive_radius(self):
        ...
        self.assertAlmostEqual(area_of_circle(5), math.pi * 5**2)
        self.assertAlmostEqual(area_of_circle(10), math.pi * 10**2)
    ...
    def test_large_radius(self):
        ...
        self.assertAlmostEqual(area_of_circle(1000), math.pi * 1000**2)
